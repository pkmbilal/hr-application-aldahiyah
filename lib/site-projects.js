...
export const SITE_PROJECT_BUCKET = process.env.R2_SITE_PROJECT_DOCUMENTS_BUCKET || "site-project-documents";
...
export async function getSiteProjectFile(id) {
  ...
  return {
    ...data,
    file_url: await createPrivateFileUrl(SITE_PROJECT_BUCKET, data.project_file_path),
  };
}
