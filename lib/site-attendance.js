...
export const SITE_ATTENDANCE_BUCKET = process.env.R2_SITE_ATTENDANCE_DOCUMENTS_BUCKET || "site-attendance-documents";
...
export async function getSiteAttendanceFile(id) {
  ...
  return {
    ...data,
    file_url: await createPrivateFileUrl(SITE_ATTENDANCE_BUCKET, data.attendance_file_path),
  };
}
