...
export const ADVANCE_TYPES = ["Job", "General"];
...
function normalizeAdvance(advance) {
  ...
  return {
    ...advance,
    advance_type: advance.advance_type || "Job",
    project_name: isGeneralAdvance ? advance.reason || "General purpose" : advance.project_name,
