...
export const COMPANY_DOCUMENT_BUCKET = process.env.R2_COMPANY_DOCUMENTS_BUCKET || "company-documents";
...
export async function withSignedCompanyDocumentUrl(document) {
  return {
    ...document,
    file_url: await createPrivateFileUrl(COMPANY_DOCUMENT_BUCKET, document.storage_path),
