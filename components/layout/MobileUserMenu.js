...
export function MobileUserMenu({ displayName, email, roleLabel, logoutAction }) {
  ...
  return (
    <div ref={containerRef} className="relative lg:hidden">
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full border border-brand-100 bg-white text-sm font-semibold text-brand-600 shadow-theme-sm ring-4 ring-brand-50"
      ...
      {isOpen ? (
        <div className="absolute right-0 top-full mt-3 w-72 overflow-hidden rounded-2xl border border-white/80 bg-white/95 shadow-[0_18px_50px_rgba(16,24,40,0.16)] ring-1 ring-gray-100 backdrop-blur">
          ...
          <div className="border-t border-gray-100 p-3">
            <Link
              ...
              className="flex min-h-11 w-full items-center gap-3 rounded-xl px-3 py-2 text-base font-semibold text-gray-800 transition hover:bg-brand-50 hover:text-brand-600"
            >
            ...
            <form action={logoutAction}>
              <button
                type="submit"
                className="flex min-h-11 w-full items-center gap-3 rounded-xl px-3 py-2 text-base font-semibold text-gray-800 transition hover:bg-rose-50 hover:text-rose-700"
              >
